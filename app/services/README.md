* A strategy is a way of answering the question posed by the user. All strategies can attempt all questions. At the end of it, we can manually or programmatically select the best strategy. 
